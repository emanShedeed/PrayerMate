...
//                                 let _ = PrayerTimeLocalNotification()
        ...
        let renewalNotificationDate = Calendar.current.date(byAdding: .day, value: -1 , to: secondDate ?? Date())
         let _ = ExportPrayerTimeToCalendarNotification(notification: Notification(title: "renew Exporting", description: "choose Ok to renew Exporting your prayer times", time: "2:23 am", date: Date()))//renewalNotificationDate
    }
